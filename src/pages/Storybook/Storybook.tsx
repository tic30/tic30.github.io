...
const Storybook = ({ scrollAreaRef }: { scrollAreaRef: RefObject<HTMLDivElement> }) => {
    ...
    return (
        ...
        >
            ...
            />
            <Container sx={{ display: 'flex', flexDirection: 'column', gap: 2 }} maxWidth="xl">
                <Typography sx={{ marginBlock: 4 }}>
                    To fully utitize Storybook as a tool to help cross functional peers(Eng, UX,
                    PM...) among a large number of teams to view, test and interact with UI
                    components with best clarity and minimum effort. This is a full stack initiative
                    that touches Node, TypeScript, CI/CD, rollup, babel, versioning, eslint, and
                    many other supportive technologies - a very fun and rewarding experience.
                </Typography>
                <Typography variant="h4">Build as a community</Typography>
                <Typography>
                    Most engineering teams already use Storybook in some way. My first effort was to
                    learn from their pain points and build up interest in making Storybook and
                    Chromatic standardized across the company. I started conversations with
                    engineers, UXers and team leads, created surveys and gave presentations to pitch
                    the idea. In a short period of time, teams showed significant interest. I also
                    received volunteering requests from a few engineers which helped push this
                    initiative forward.
                </Typography>
                <Typography variant="h4">Identify workflow</Typography>
                <List>
                    <ListItem>PM & Eng leaders: Document and track feature iterations</ListItem>
                    <ListItem>
                        UXers: See all UI component straightfoward; Review changes in Chromatic;
                        Communicate changes
                    </ListItem>
                    <ListItem>
                        Engineers: Build UI in isolation, test variants, test user interactions.
                    </ListItem>
                    <ListItem>Code quality control: Automations and test coverage</ListItem>
                    <ListItem>
                        Internationalization: Verify translations, verify RTL/LTR alignments work
                    </ListItem>
                </List>
                <Typography variant="h4">Implementation</Typography>
                <Typography>
                    First of all, I created a central repository that manages all Storybook
                    dependencies and recommended addons.
                </Typography>
                <List>
                    <ListItem>
                        <ListItemText
                ...
                <Typography>
                    Teams use Storybook in very different ways. After many iterations, the most
                    straightfoward steps are summarized and advocated to engineers. I set up rules
                    and best practises to ensure the adoption is progressive and streamlined. The
                ...
                <List>
                    <ListItem>
                        Chromatic is set up as a step in CI to auto build, deploy, send alerts in
                        merge requests and start review sessions when UI changes.
                    </ListItem>
                    <ListItem>
                        We also deploy static Storybook pages for non engineers to have quick
                        access.
                    </ListItem>
                    <ListItem>
                        Interaction tests are executed in CI and its coverage is combined with unit
                        test coverage to produce an accurate overall coverage.
                    </ListItem>
                </List>
                <Typography variant="h4">Documentation</Typography>
                <Typography>
                    Aside from the utility library, I released a guideline doc simultaneously which
                    answers many "what", "why" and "how" questions.
                </Typography>
                <List>
                    <ListItem>
                        <ListItemText
                ...
                <Typography>
                    After one year of pushing this initiative across company, feedbacks are very
                    positive. Number one most shared feedback from all roles is how it made
                    communication and validation a lot easier and faster. As the development
                    advances into next phase, we will prioritize feature requests, adding more setup
                    assistance(npx script, repository template etc.), and fine tune guideline
