...
const AboutMeCardUX = () => (
    <StyledAboutMeCard>
        ...
        <Typography className="aboutme-card-content">
            My passion is to bridge design and engineering, deliver high quality UI code and
            galvanize front end team towards product vision that serves users' critical interests.
        </Typography>
    </StyledAboutMeCard>
);
