        ...
        <>
            ...
            <Paper sx={paperSx}>
                ...
                <Box>
                    ...
                    <Typography sx={{ mb: 3 }}>
                        Working in UX org, I push towards consistent user experience across Indeed
                        products.
                    </Typography>
                    <Typography sx={{ mb: 3 }}>
                        I advocate the adoption of the latest design and UI libraries across teams,
                        identify broken experiences and coordinate with engineers and other UX
