...
const ITS = () => {
	...
	const sec2Title = useRef(null);
	const player = useRef(null);
	const endOfSec2 = useRef(null);
	...
	const scrollEvent = () => {
		if (isInOrPassedViewport(endOfSec2.current)) {
			setScrollLevel(3);
		} else if (isInOrPassedViewport(player.current)) {
			setScrollLevel(2);
		} else if (isInOrPassedViewport(sec2Title.current)) {
			setScrollLevel(1);
		} else {
			setScrollLevel(0);
		}
	...
	return (
		<>
			...
			<div id="its-sec1-placeholder" />
			<section id="its-sec2">
				<div className="container">
					<h3 ref={sec2Title}>To improve the<br /><span className="text-blue">effectiveness</span> of teaching<br />meets teachers' urgent need.</h3>
					...
					<div className="playerStart" ref={player} />
					<YouTubePlayer />
					<div className="endOfSec2" ref={endOfSec2} />
				</div>
			</section>
			<section id="its-sec3">
			...
			<section id="its-sec6">
				...
				<div className="container">
					...
					<div className="tech-imgs-wrapper">
						{Texts.ITSTech.map((item, index) => <img className="tech-imgs" src={mobile ? item.msrc : item.src} alt={item.alt} key={index} />)}
					</div>
				</div>
			</section>
			<section id="its-sec7">
